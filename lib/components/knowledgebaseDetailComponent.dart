...
class KnowledgeBaseDetailComponent extends StatefulWidget {
  static String tag = '/MLProductDetailComponent';

  @override
  KnowledgeBaseDetailComponentState createState() =>
      KnowledgeBaseDetailComponentState();
}

class KnowledgeBaseDetailComponentState
    extends State<KnowledgeBaseDetailComponent> {
