...
class FacilityDetailComponent extends StatefulWidget {
  static String tag = '/MLHospitalDetailComponent';

  @override
  FacilityDetailComponentState createState() => FacilityDetailComponentState();
}

class FacilityDetailComponentState extends State<FacilityDetailComponent> {
  String? hospitalName = 'Kenyatta National Hospital -';
  String? hospitalCity = 'Nairobi ';
